...
/***/ "./src/components/getInspectorControls.js":
/*!************************************************!*\
  !*** ./src/components/getInspectorControls.js ***!
  \************************************************/
...
/* harmony export */   "getInspectorControls": function() { return /* binding */ getInspectorControls; }
/* harmony export */ });
...
const getInspectorControls = _ref => {
  let {
    attributes,
    setAttributes
  } = _ref;
...
/* harmony import */ var _components_getInspectorControls__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/getInspectorControls */ "./src/components/getInspectorControls.js");
...
function Edit(props) {
  ...
  return [(0,_components_getInspectorControls__WEBPACK_IMPORTED_MODULE_3__.getInspectorControls)(props), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: className
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)("oja/oja-related-post-block", {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkoja_related_post_block"] = self["webpackChunkoja_related_post_block"] || [];
